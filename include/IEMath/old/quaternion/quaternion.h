...
#include <mathlib/epsilon.h>
#include <quaternion/quaternion_expr.h>
#include <quaternion/quaternion_dot.h>
#include <util.h>
...
class quaternion
{
  ...
  public:
    ...
    typedef IEMath::et::quaternion_result_tag result_tag;
  ...
  public:
    ...
    quaternion_type& conjugate() {
        return (*this) = IEMath::conjugate(*this);
    }

    /** Set this quaternion to the inverse. */
    quaternion_type& inverse() {
        return (*this) = IEMath::inverse(*this);
    }
...
#define CML_QUAT_ASSIGN_FROM_SCALAR(_op_,_op_name_)               \
    ...
    CML_QUAT_ASSIGN_FROM_SCALAR(*=, IEMath::et::OpMulAssign)
    CML_QUAT_ASSIGN_FROM_SCALAR(/=, IEMath::et::OpDivAssign)
...
#undef CML_QUAT_ASSIGN_FROM_SCALAR
     ...
     *
     * @internal Using operator* here is okay, as long as IEMath/quaternion.h
     ...
     *
     * @internal Using operator* and IEMath::inverse here is okay, as long as
     * IEMath/quaternion.h is included before using this method (the only
     ...
     */
    quaternion_type& operator/=(const quaternion_type& q) {
        return (*this = *this * IEMath::inverse(q));
    }
     ...
     */
    template<typename XprT> quaternion_type& operator/=(QUATXPR_ARG_TYPE e) {
        return (*this = *this * IEMath::inverse(e));
    }
    #endif
