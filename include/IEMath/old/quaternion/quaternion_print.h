...
operator<<(std::ostream& os, const IEMath::quaternion<E,AT,scalar_first,CT>& q)
{
...
template<typename E, class AT, class CT> std::ostream&
operator<<(std::ostream& os, const IEMath::quaternion<E,AT,vector_first,CT>& q)
{
...
operator<<(std::ostream& os, const IEMath::quaternion<E,AT,OT,CT>& q)
{
    typedef typename IEMath::quaternion<E,AT,OT,CT>::order_type order_type;
    enum {
        W = order_type::W,
        X = order_type::X,
        Y = order_type::Y,
