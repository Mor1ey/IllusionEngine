...
#define _DO_MATRIX_SET_RESIZE(_R_,_C_) IEMath::et::detail::Resize(*this,_R_,_C_)
#else
...
{                                                                       \
    ...
    IEMath::matrix<element, external<2,2>, basis_orient, row_major>        \
        src(&v[0][0]);                                                  \
...
{                                                                       \
    ...
    typedef et::OpAssign<Element,Element> OpT;                          \
    typedef const value_type element;                                   \
    IEMath::matrix<element, external<3,3>, basis_orient, row_major>        \
        src(&v[0][0]);                                                  \
    et::UnrollAssignment<OpT>(*this,src);                               \
    return *this;                                                       \
}
...
{                                                                       \
    ...
    typedef et::OpAssign<Element,Element> OpT;                          \
    typedef const value_type element;                                   \
    IEMath::matrix<element, external<4,4>, basis_orient, row_major>        \
        src(&v[0][0]);                                                  \
    et::UnrollAssignment<OpT>(*this,src);                               \
    return *this;                                                       \
}
...
matrix(const value_type m[_R_][_C_]) {                                  \
    typedef et::OpAssign<Element,Element> OpT;                          \
    IEMath::matrix<const value_type, external<_R_,_C_>,                    \
...
matrix(const value_type* const v, size_t R, size_t C) _add_ {           \
    typedef et::OpAssign<Element,Element> OpT;                          \
    IEMath::matrix<value_type, external<>, basis_orient,                   \
...
matrix_type& operator*=(_arg_type_ m) {                                 \
    ...
    IEMath::et::CheckedSquare(*this, typename result_type::size_tag());    \
    return (*this = (*this)*m);                                         \
}
