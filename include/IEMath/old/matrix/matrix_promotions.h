...
template<typename LeftT, typename RightT> struct MatrixPromote
{
    ...
    IEMath::matrix<E1,AT1,BO1,L1>, IEMath::matrix<E2,AT2,BO2,L2>
    >
    {
        /* Promote the arrays: */
        typedef typename ArrayPromote<
            typename IEMath::matrix<E1,AT1,BO1,L1>::array_type,
        typename IEMath::matrix<E2,AT2,BO2,L2>::array_type
            >::type promoted_array;

        /* The deduced matrix result type: */
        typedef IEMath::matrix<
    ...
    struct MatrixPromoteHelper<IEMath::matrix<E,AT,BO,L>, S>
    {
        /* The deduced matrix result type (the array type is the same): */
        typedef IEMath::matrix<typename ScalarPromote<E,S>::type, AT, BO, L> type;
    ...
    struct MatrixPromoteHelper<S, IEMath::matrix<E,AT,BO,L> >
    {
        /* The deduced matrix result type (the array type is the same): */
        typedef IEMath::matrix<typename ScalarPromote<S,E>::type, AT, BO, L> type;
    ...
    struct MatrixPromoteHelper< IEMath::vector<E1,AT1>, IEMath::vector<E2,AT2> >
    {
        typedef IEMath::vector<E1,AT1> left_type;
        typedef IEMath::vector<E2,AT2> right_type;
        ...
        typedef typename select_if<
            ...
            >::result left_storage;
        typedef IEMath::matrix<E1,left_storage,basis_orient,layout> left_matrix;

        typedef typename select_if<
            array_cols == -1, dynamic<>, fixed<1,array_cols>
            >::result right_storage;
        typedef IEMath::matrix<E2,right_storage,basis_orient,layout> right_matrix;
