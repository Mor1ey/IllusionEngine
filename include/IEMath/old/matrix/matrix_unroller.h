...
class MatrixAssignmentUnroller
{
  protected:
    ...
    typedef IEMath::matrix<E,AT,BO,L> matrix_type;
  ...
  public:
    ...
    void operator()(
            IEMath::matrix<E,AT,BO,L>& dest, const SrcT& src, IEMath::fixed_size_tag)
    {
        typedef IEMath::matrix<E,AT,BO,L> matrix_type;
        enum {
  ...
  private:
    ...
    matrix_size CheckOrResize(
            matrix_type& dest, const SrcT& src, IEMath::resizable_tag)
    {
    ...
    matrix_size CheckOrResize(
            matrix_type& dest, const SrcT& src, IEMath::not_resizable_tag)
    {
  ...
  public:
     ...
     * layout access.
     */
    void operator()(matrix_type& dest, const SrcT& src, IEMath::dynamic_size_tag)
    {
        typedef ExprTraits<SrcT> src_traits;
...
inline void UnrollAssignment(IEMath::matrix<E,AT,BO,L>& dest, const SrcT& src)
{
