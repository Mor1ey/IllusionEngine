...
#include <matvec/matvec_promotions.h>
...
mul(const LeftT& A, const RightT& x, mul_Ax)
{
    ...
    result_type y; IEMath::et::detail::Resize(y, N);
          ...
          const et::VectorXpr<XprT>& right)
{
    ...
    IEMath::et::detail::Resize(right_tmp,right.size());
    right_tmp = right;
          ...
          const vector<E,AT>& right)
{
    ...
    IEMath::et::detail::Resize(left_tmp,left.rows(),left.cols());
    left_tmp = left;
          ...
          const et::MatrixXpr<XprT>& right)
{
    ...
    IEMath::et::detail::Resize(right_tmp,right.rows(),right.cols());
    right_tmp = right;
          ...
          const matrix<E,AT,BO,L>& right)
{
    ...
    IEMath::et::detail::Resize(left_tmp,left.size());
    left_tmp = left;
