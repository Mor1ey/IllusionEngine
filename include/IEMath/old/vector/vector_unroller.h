...
class VectorAssignmentUnroller
{
  protected:
    ...
    typedef IEMath::vector<E,AT> vector_type;
  ...
  public:
    ...
    void operator()(vector_type& dest, const SrcT& src, IEMath::fixed_size_tag)
    {
        typedef IEMath::vector<E,AT> vector_type;
  ...
  private:
    ...
    size_t CheckOrResize(
            vector_type& dest, const SrcT& src, IEMath::resizable_tag)
    {
        ...
        IEMath::et::detail::Resize(dest,N);
#else
    ...
    size_t CheckOrResize(
            vector_type& dest, const SrcT& src, IEMath::not_resizable_tag)
    {
  ...
  public:
    ...
    void operator()(vector_type& dest, const SrcT& src, IEMath::dynamic_size_tag)
    {
        /* Shorthand: */
        typedef ExprTraits<SrcT> src_traits;
...
void UnrollAssignment(IEMath::vector<E,AT>& dest, const SrcT& src)
{
