...
#define _DO_VECTOR_SET_RESIZE(_N_)  IEMath::et::detail::Resize(*this,_N_)
#else
...
set(ELEMENT_ARG_TYPE e0, ELEMENT_ARG_TYPE e1) {                         \
    ...
    IEMath::vector< const value_type, external<2> > src(v);                \
...
{                                                                       \
    ...
    typedef et::OpAssign<Element,Element> OpT;                          \
    IEMath::vector< const value_type, external<3> > src(v);                \
    et::UnrollAssignment<OpT>(*this,src);                               \
    return *this;                                                       \
}
...
{                                                                       \
    ...
    typedef et::OpAssign<Element,Element> OpT;                          \
    IEMath::vector< const value_type, external<4> > src(v);                \
    et::UnrollAssignment<OpT>(*this,src);                               \
    return *this;                                                       \
}
...
vector(const value_type v[_N_]) _add_ {                                 \
    typedef et::OpAssign<Element,Element> OpT;                          \
    IEMath::vector< const value_type, external<_N_> > src(v);              \
    et::UnrollAssignment<OpT>(*this,src);                               \
}
...
vector(const value_type* const v, size_t N) _add_ {                     \
    typedef et::OpAssign<Element,Element> OpT;                          \
    IEMath::vector<const value_type, external<> > src(v,N);                \
    et::UnrollAssignment<OpT>(*this,src);                               \
}
...
operator _op_ (const IEMath::vector<E,AT>& m) {                            \
    typedef _op_name_ <Element,E> OpT;                                  \
    IEMath::et::UnrollAssignment<OpT>(*this,m);                            \
    return *this;                                                       \
}
...
operator _op_ (VECXPR_ARG_TYPE e) {                                     \
    ...
    IEMath::et::UnrollAssignment<OpT>(*this,e);                            \
    return *this;                                                       \
}
...
vector_type& operator _op_ (ELEMENT_ARG_TYPE s) {                       \
    ...
    IEMath::et::UnrollAssignment<OpT>(*this,s);                            \
    return *this;                                                       \
}
