========================================================================
    PROYECTO MAKEFILE: Información general de IEMath
========================================================================

AppWizard ha creado este proyecto IEMath.  

Este archivo contiene un resumen de lo que encontrará en todos los archivos
que constituyen el proyecto IEMath.
...
Este proyecto permite compilar/limpiar/recompilar desde Visual Studio llamando 
a los comandos que ha introducido en el asistente. El comando de compilación 
puede ser nmake o cualquier otra herramienta que utilice.

Este proyecto no contiene ningún archivo, por lo que no se muestra ninguno en 
