========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: IEWin32Render 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL IEWin32Render.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación IEWin32Render.


IEWin32Render.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado IEWin32Render.pch y un archivo de tipos 
